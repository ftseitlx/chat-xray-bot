...
9. **Сравнительный анализ метрик**: Постройте таблицу, в которой по каждому участнику показаны средние значения эмоционального тона, токсичности, манипулятивности, эмпатии, ассертивности и других количественных показателей.
